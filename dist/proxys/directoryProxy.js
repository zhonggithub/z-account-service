...
let isExist = (() => {
  var _ref = _asyncToGenerator(function* (info) {
    try {
      const result = yield _operators.directoryOperator.list({ name: info.name });
      return {
        is: result.length !== 0,
        description: '',
        infos: result
...
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; } /*
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            * @Last Modified by: Zz
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            * @Last Modified time: 2017-01-17 20:56:55
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            */
...
function retData(body) {
  ...
  body.href = `http://localhost:3000/api/account/v1/tenants/${ body.tenantId }/directories/${ body.id }`;
  return body;
}
...
module.exports = {
  resourceProxy: _operators.directoryOperator,
  isValidData,
  isExist,
  retData,
  retListData,
