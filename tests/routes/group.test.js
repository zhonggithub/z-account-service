...
test('get /api/account/v1/groups/:id ok', async (t) => {
  const url = `/api/account/v1/groups/${id}`;
...
test('post /api/account/v1/groups/:id ok', async (t) => {
  const url = `/api/account/v1/groups/${id}`;
...
test('get /api/account/v1/groups ok', async (t) => {
...
test('delete /api/account/v1/groups/:id ok', async (t) => {
  const url = `/api/account/v1/groups/${id}`;
